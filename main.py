...
def start(client, message):
    ...
    app.send_message(chat_id=message.from_user.id, text=f"H, I am **TikTok Downloader Bot**.\nI can download TikTok video without Watermark.\n\n"
...
def help(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/azaas411/TikTok-Downloader-Bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"مرحبا,  **بوت تحميل فيديوهات من التيك توك **.\nI \بدون علامة مائية.\n\n"
